...
import logic.DocumentCommander;
...
public class MainF extends JFrame {
	...
	public MainF() {
		...
		tabPane.addTab("S�k", null, searchTab, null);
		...
		btnSk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DocumentCommander searchDoc = new DocumentCommander();
						
				searchDoc.searchDocument((String) comboBox.getSelectedItem(), textFieldSearch.getText());
				searchList.setListData(searchDoc.getSearchDocuments());
